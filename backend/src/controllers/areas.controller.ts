...
const service = new BaseService('areas')
...
export class AreasController {
  ...
  async criar(req: AuthRequest, res: Response) {
    ...
    return successResponse(res, data, 'Área criada com sucesso', 201)
  }
  ...
  async deletar(req: AuthRequest, res: Response) {
    ...
    return successResponse(res, null, 'Área removida com sucesso')
  }
}
